...
# direct methods
.method public static -$$Nest$monBackToLauncherAnimationFinished(Lcom/android/wm/shell/back/BackAnimationController;)V
    .locals 3
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/wm/shell/common/ShellExecutor;)V
    .locals 7
...
.method public final onMotionEvent(IILandroid/view/MotionEvent;)V
    .locals 10
    ...
    .line 11
    .line 12
    sget-boolean v5, Lcom/android/wm/shell/protolog/ShellProtoLogCache;->WM_SHELL_BACK_PREVIEW_enabled:Z
    ...
    .line 28
    .line 29
    const-string p1, "initAnimation mMotionStarted=%b"

    .line 30
    .line 31
    invoke-static {v5, v6, v3, p1, v7}, Lcom/android/wm/shell/protolog/ShellProtoLogImpl;->d(Lcom/android/wm/shell/protolog/ShellProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 42
    :cond_1
    const-string p1, "Animation is being initialized but is already started."
    ...
    .line 50
    :cond_2
    iget-object p1, p0, Lcom/android/wm/shell/back/BackAnimationController;->mInitTouchLocation:Landroid/graphics/PointF;
    ...
    .line 62
    .line 63
    iput-boolean v4, p0, Lcom/android/wm/shell/back/BackAnimationController;->mBackGestureStarted:Z
    ...
    .line 66
    .line 67
    invoke-interface {p1}, Landroid/app/IActivityTaskManager;->startBackNavigation()Landroid/window/BackNavigationInfo;
    ...
    .line 100
    iget-object v2, p0, Lcom/android/wm/shell/back/BackAnimationController;->mInitTouchLocation:Landroid/graphics/PointF;
    ...
    .line 109
    sget v2, Lcom/android/wm/shell/back/BackAnimationController;->PROGRESS_THRESHOLD:I
    ...
    .line 115
    :cond_5
    iget v2, p0, Lcom/android/wm/shell/back/BackAnimationController;->mProgressThreshold:F
    ...
    .line 141
    .line 142
    invoke-virtual {v2}, Landroid/window/BackNavigationInfo;->getDepartingAnimationTarget()Landroid/view/RemoteAnimationTarget;
    ...
    .line 158
    invoke-direct/range {v4 .. v9}, Landroid/window/BackEvent;-><init>(FFFILandroid/view/RemoteAnimationTarget;)V
    ...
    .line 162
    invoke-virtual {p0, p1}, Lcom/android/wm/shell/back/BackAnimationController;->shouldDispatchToLauncher(I)Z
    ...
    .line 167
    .line 168
    iget-object p2, p0, Lcom/android/wm/shell/back/BackAnimationController;->mBackToLauncherCallback:Landroid/window/IOnBackInvokedCallback;
    ...
    :cond_9
    :try_start_1
    invoke-interface {p2, v2}, Landroid/window/IOnBackInvokedCallback;->onBackProgressed(Landroid/window/BackEvent;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    .line 195
    const-string p1, "dispatchOnBackProgressed error: "
    ...
    .line 211
    sget-object p3, Lcom/android/wm/shell/protolog/ShellProtoLogGroup;->WM_SHELL_BACK_PREVIEW:Lcom/android/wm/shell/protolog/ShellProtoLogGroup;
    ...
    .line 223
    .line 224
    const-string p1, "Finishing gesture with event action: %d"

    .line 225
    .line 226
    invoke-static {p3, v1, v4, p1, v3}, Lcom/android/wm/shell/protolog/ShellProtoLogImpl;->d(Lcom/android/wm/shell/protolog/ShellProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 247
    .line 248
    const-string/jumbo p1, "onGestureFinished() mTriggerBack == %s"

    .line 249
    .line 250
    .line 251
    invoke-static {p2, p3, v2, p1, v1}, Lcom/android/wm/shell/protolog/ShellProtoLogImpl;->d(Lcom/android/wm/shell/protolog/ShellProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 272
    .line 273
    iget-object p3, p0, Lcom/android/wm/shell/back/BackAnimationController;->mBackToLauncherCallback:Landroid/window/IOnBackInvokedCallback;
    ...
    .line 276
    :cond_f
    iget-object p3, p0, Lcom/android/wm/shell/back/BackAnimationController;->mBackNavigationInfo:Landroid/window/BackNavigationInfo;

    .line 277
    .line 278
    invoke-virtual {p3}, Landroid/window/BackNavigationInfo;->getOnBackInvokedCallback()Landroid/window/IOnBackInvokedCallback;
    ...
    :cond_10
    :try_start_2
    invoke-interface {p3}, Landroid/window/IOnBackInvokedCallback;->onBackInvoked()V
    :try_end_2
    ...
    :cond_12
    :try_start_3
    invoke-interface {p3}, Landroid/window/IOnBackInvokedCallback;->onBackCancelled()V
    :try_end_3
