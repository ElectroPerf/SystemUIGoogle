...
.method public static getGoneState(Lcom/android/systemui/util/animation/TransitionViewState;Lcom/android/systemui/util/animation/DisappearParameters;FLcom/android/systemui/util/animation/TransitionViewState;)Lcom/android/systemui/util/animation/TransitionViewState;
    ...
    .line 0
    invoke-virtual {p1}, Lcom/android/systemui/util/animation/DisappearParameters;->getDisappearStart()F
    ...
    .line 4
    invoke-virtual {p1}, Lcom/android/systemui/util/animation/DisappearParameters;->getDisappearEnd()F
    ...
    .line 23
    invoke-virtual {p0}, Lcom/android/systemui/util/animation/TransitionViewState;->getWidth()I
    ...
    .line 33
    invoke-virtual {p1}, Lcom/android/systemui/util/animation/DisappearParameters;->getDisappearSize()Landroid/graphics/PointF;
    ...
    .line 45
    invoke-virtual {p3, v0}, Lcom/android/systemui/util/animation/TransitionViewState;->setWidth(I)V

    .line 46
    .line 47
    .line 48
    invoke-virtual {p0}, Lcom/android/systemui/util/animation/TransitionViewState;->getHeight()I
    ...
    .line 70
    invoke-virtual {p3, v0}, Lcom/android/systemui/util/animation/TransitionViewState;->setHeight(I)V
    ...
    .line 87
    invoke-virtual {p1}, Lcom/android/systemui/util/animation/DisappearParameters;->getGonePivot()Landroid/graphics/PointF;
    ...
    .line 123
    invoke-virtual {p1}, Lcom/android/systemui/util/animation/DisappearParameters;->getContentTranslationFraction()Landroid/graphics/PointF;
    ...
    .line 158
    .line 159
    invoke-virtual {p1}, Lcom/android/systemui/util/animation/DisappearParameters;->getFadeStartPosition()F
...
.method public final getInterpolatedState(Lcom/android/systemui/util/animation/TransitionViewState;Lcom/android/systemui/util/animation/TransitionViewState;FLcom/android/systemui/util/animation/TransitionViewState;)Lcom/android/systemui/util/animation/TransitionViewState;
    ...
    .line 38
    invoke-virtual {v1}, Lcom/android/systemui/util/animation/TransitionViewState;->getWidgetStates()Ljava/util/LinkedHashMap;
    ...
    .line 57
    .line 58
    invoke-direct {v7, v8}, Lcom/android/systemui/util/animation/WidgetState;-><init>(I)V

    .line 59
    .line 60
    .line 61
    :cond_2
    invoke-virtual/range {p1 .. p1}, Lcom/android/systemui/util/animation/TransitionViewState;->getWidgetStates()Ljava/util/LinkedHashMap;
    ...
    .line 78
    :cond_3
    invoke-virtual/range {p2 .. p2}, Lcom/android/systemui/util/animation/TransitionViewState;->getWidgetStates()Ljava/util/LinkedHashMap;
    ...
    .line 122
    .line 123
    invoke-static {v11, v14, v12, v14, v0}, Landroid/util/MathUtils;->map(FFFFF)F
    ...
    .line 138
    invoke-static {v11, v12, v0}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    .line 182
    invoke-static {v15, v2, v0}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    .line 197
    .line 198
    invoke-static {v12, v2, v12, v4, v0}, Landroid/util/MathUtils;->map(FFFFF)F
    ...
    .line 213
    invoke-static {v2, v11, v0}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    .line 257
    invoke-static {v12, v15, v0}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    .line 262
    :goto_5
    invoke-virtual {v7, v13}, Lcom/android/systemui/util/animation/WidgetState;->setGone(Z)V
    ...
    .line 322
    .line 323
    invoke-virtual {v7, v14}, Lcom/android/systemui/util/animation/WidgetState;->setX(F)V
    ...
    .line 337
    invoke-static {v2, v14, v10}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    .line 354
    invoke-static {v2, v10, v12}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    .line 372
    invoke-static {v2, v8, v12}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    .line 379
    .line 380
    invoke-virtual {v7, v11}, Lcom/android/systemui/util/animation/WidgetState;->setScale(F)V

    .line 381
    .line 382
    .line 383
    invoke-virtual {v7, v13}, Lcom/android/systemui/util/animation/WidgetState;->setMeasureWidth(I)V
