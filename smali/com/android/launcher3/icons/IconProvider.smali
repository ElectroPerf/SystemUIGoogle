...
.method public final getIcon(ILandroid/content/pm/ActivityInfo;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v1, p0, p2, p1}, Lcom/android/launcher3/icons/IconProvider$$ExternalSyntheticLambda0;-><init>(Lcom/android/launcher3/icons/IconProvider;Landroid/content/pm/ActivityInfo;I)V

    .line 3
    iget-object p2, p0, Lcom/android/launcher3/icons/IconProvider;->mCalendar:Landroid/content/ComponentName;
    ...
    .line 4
    iget-object p2, p0, Lcom/android/launcher3/icons/IconProvider;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p2, v0, v3}, Landroid/content/pm/PackageManager;->getActivityInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {p2, v3}, Landroid/content/pm/PackageManager;->getResourcesForApplication(Ljava/lang/String;)Landroid/content/res/Resources;
    ...
    .line 8
    invoke-virtual {v0, p0, v3}, Landroid/os/BaseBundle;->getInt(Ljava/lang/String;I)I
    ...
    .line 12
    :try_start_2
    invoke-virtual {p2, v3, p1, v2}, Landroid/content/res/Resources;->getDrawableForDensity(IILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 14
    :cond_3
    iget-object p2, p0, Lcom/android/launcher3/icons/IconProvider;->mClock:Landroid/content/ComponentName;
    ...
    invoke-static {p2, p0, p1}, Lcom/android/launcher3/icons/ClockDrawableWrapper;->forPackage(Landroid/content/Context;Ljava/lang/String;I)Lcom/android/launcher3/icons/ClockDrawableWrapper;
    ...
    .line 16
    invoke-virtual {v1}, Lcom/android/launcher3/icons/IconProvider$$ExternalSyntheticLambda0;->get()Ljava/lang/Object;
    ...
    instance-of p0, v2, Landroid/graphics/drawable/AdaptiveIconDrawable;
